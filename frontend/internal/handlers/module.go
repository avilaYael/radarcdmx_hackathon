...
var Module = fx.Module("handlers",
	fx.Provide(
		...
		route.As(NewListZoningHandler),
		route.As(NewListMercadosHandler),
		route.As(NewListActividadHandler),
		route.As(NewListMunicipioHandler),
		route.As(NewListCompareMunicipiosHandler),
		route.As(NewListUsoDeSueloHandler),
		route.As(NewListEstablecimientoHandler),
		route.As(NewListEstablecimientoNearbyHandler),
		route.As(NewDictamenUsoDeSueloHandler),
	),
)
